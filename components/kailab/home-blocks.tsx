        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="lg:col-span-4">
            <div className="mb-4 flex items-center gap-2 text-primary">
               ...
               <span className="font-mono text-xs font-bold uppercase tracking-widest text-primary/80">Dotación de Envíos</span>
            </div>
          ...
          <div className="lg:col-span-8">
            <div className="grid gap-4 sm:grid-cols-2">
              {items.map((item, i) => (
                <div key={i} className="group relative overflow-hidden bg-background p-6 transition-all duration-500 hover:-translate-y-1">
                  {/* Decorative asymmetric borders */}
                  <div className="absolute left-0 top-0 h-full w-[2px] bg-border transition-colors duration-500 group-hover:bg-primary"></div>
                  <div className="absolute left-0 top-0 h-[2px] w-8 bg-border transition-all duration-500 group-hover:w-full group-hover:bg-primary/50"></div>
                  
                  <div className="absolute -right-4 -top-4 opacity-[0.015] transition-all duration-500 group-hover:-rotate-12 group-hover:scale-150 group-hover:text-primary group-hover:opacity-[0.03]">
                    <Icon icon={item.icon} className="h-32 w-32 [&_*]:!stroke-[0.25px]" />
                  </div>
        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            <div className="mb-4 flex items-center gap-2 text-primary">
               ...
               <span className="font-mono text-xs font-bold uppercase tracking-widest text-primary/80">Laboratorio Analítico</span>
            </div>
            <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
            ...
            <div className="mt-8">
              <a href="#calidad" className="group inline-flex items-center gap-2 font-mono text-sm font-bold text-primary transition-all hover:text-primary/80">
                <span className="border-b border-primary/50 pb-0.5 transition-all group-hover:border-primary">Ver reporte de ejemplo</span>
             ...
             <div className="group relative overflow-hidden border border-border/40 bg-background/50 p-8 backdrop-blur-md">
                ...
                <div className="mb-6 flex items-center justify-between border-b border-border/40 pb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-mono text-sm font-bold text-foreground">REPORTE_HPLC-MS.pdf</span>
                  </div>
                  <span className="animate-pulse rounded-sm bg-primary/20 px-2 py-0.5 font-mono text-[10px] text-primary">VERIFICADO</span>
                </div>
                ...
                <div className="space-y-5 font-mono text-sm">
                  <div className="group/row flex items-center justify-between">
                     ...
                     <span className="text-foreground">Cromatografía HPLC</span>
                  </div>
                  <div className="group/row flex items-center justify-between">
                  ...
                  <div className="group/row flex items-center justify-between">
                     ...
                     <span className="text-foreground">Código QR en vial</span>
                  </div>
                  <div className="group/row mt-2 flex items-center justify-between border-t border-border/40 pt-4">
                     ...
                     <span className="max-w-[150px] truncate text-xs text-primary/70">0x3F9A...B8C2</span>
                  </div>
               </div>
             </div>
          </div>
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="lg:col-span-4 lg:col-start-9">
            <div className="mb-4 flex items-center justify-start gap-2 text-primary lg:justify-end">
               ...
               <span className="font-mono text-xs font-bold uppercase tracking-widest text-primary/80">Recursos Técnicos</span>
            </div>
            <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl lg:text-right">
              Protocolos<br/>RUO
            </h2>
            <p className="mt-4 text-base text-muted-foreground lg:text-right">
                ...
                <a href="#guias" key={i} className="group relative flex items-center justify-between border-b border-border/40 py-6 transition-all duration-500 hover:bg-secondary/10 hover:pl-6">
                  ...
                  <div className="flex items-center gap-6">
                    <div className="text-muted-foreground transition-colors duration-300 group-hover:text-primary">
                      <Icon icon={guide.icon} className="h-6 w-6" />
                    </div>
                    <div>
                      <h3 className="font-mono text-sm font-semibold tracking-tight text-foreground transition-colors group-hover:text-primary md:text-base">
                        {guide.title}
                      </h3>
                  ...
                  <div className="hidden pr-4 sm:block">
                     <Icon icon="lucide:arrow-up-right" className="h-5 w-5 text-muted-foreground transition-all duration-300 group-hover:rotate-45 group-hover:text-primary" />
                  </div>
                </a>
              ))}
            </div>
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="lg:col-span-4">
            <div className="mb-4 flex items-center gap-2 text-primary">
               ...
               <span className="font-mono text-xs font-bold uppercase tracking-widest text-primary/80">Base de Conocimiento</span>
            </div>
            <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
                ...
                >
                  <summary className="flex cursor-pointer items-center justify-between p-5 focus:outline-none sm:p-6">
                    <div className="flex items-center gap-4 sm:gap-6">
                      <h4 className="font-mono text-sm font-semibold tracking-tight text-foreground transition-colors group-hover:text-primary md:text-base">
                        {faq.q}
                      </h4>
                    </div>
                    <span className="ml-4 flex h-8 w-8 shrink-0 items-center justify-center rounded-sm border border-border/50 bg-background text-muted-foreground transition-all duration-300 group-open:rotate-45 group-open:border-primary/50 group-open:text-primary group-hover:border-primary/50 group-hover:text-primary">
                      <Icon icon="lucide:plus" className="h-4 w-4" />
                    </span>
                  </summary>
                  
                  <div className="border-t border-border/20 bg-background/40 px-5 pb-6 pt-4 backdrop-blur-sm sm:px-6">
